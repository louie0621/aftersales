            ...
            <div class="row">
                <div class="col-12 col-lg-4 d-flex">
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ url('/FAS/add-dealer') }}">
                                @csrf
                                <div class="col-12">
                                    <label class="form-label">Dealer</label>
                                    <input type="text" class="form-control @error('dealer') is-invalid @enderror" name="dealer" value="{{ old('dealer') }}" autofocus>
                                    @error('dealer')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <a href="javascript:;" id="edit" data-editid="{{ $data->id }}" data-editview="{{ $data->dealer }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"> Update Dealer</h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#editsave').click(function(e) {
            e.preventDefault();
            var url = "{{ url('FAS/dealer') }}" + "/" + $('#eid').val();
            if (!$('#enm').val()) {
        ...
        $(document).on("click", "#delete", function(e) {
            var url = "{{ url('/FAS/deletedealer') }}" + "/" + $(e.currentTarget).data("deleteid");
