...
<section class="bg-gray-7">
    <div class="breadcrumbs-custom box-transform-wrap context-dark">
        <div class="container">
            <h3 class="breadcrumbs-custom-title">New Holland TT3.50</h3>
    ...
    <div class="container">
        <ul class="breadcrumbs-custom-path">
            ...
            <li class="active">New Holland TT3.50</li>
        </ul>
    </div>
</section>
<!-- Project Page-->
            ...
            <div class="col-lg-6 col-xl-7">
                <div class="slick-project">
                    ...
                    <div class="slick-slider carousel-parent" data-arrows="true" data-autoplay="true" data-swipe="true" data-items="1" data-child="#child-carousel-7" data-for="#child-carousel-7" data-slide-effect="true">
                        <div class="item"><img src="{{ asset('images/product-tt3.50.jpg') }}" alt="" width="670" height="477" />
                            <div class="slick-project-caption">
                                <div class="slick-project-title">TT3.50</div>
                            </div>
                        </div>
                        <div class="item"><img src="{{ asset('images/product-tt3-6.jpg')}}" alt="" width="670" height="477" />
                            <div class="slick-project-caption">
                                <div class="slick-project-title">TT3.50</div>
                            </div>
                        </div>
                        <div class="item"><img src="{{ asset('images/product-tt3-7.jpg')}}" alt="" width="670" height="477" />
                            <div class="slick-project-caption">
                                <div class="slick-project-title">TT3.50</div>
                            </div>
                        </div>
