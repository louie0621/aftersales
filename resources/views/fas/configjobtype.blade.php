        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Job Type List</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 d-flex">
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ url('/FAS/addjob-type') }}">
                                @csrf
                                <div class="col-12">
                                    <label class="form-label">Job Type</label>
                                    <input type="text" class="form-control @error('jobtype') is-invalid @enderror" name="jobtype" value="{{ old('jobtype') }}" autofocus>
                                    @error('jobtype')
