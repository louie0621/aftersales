                                                    ...
                                                    <div class="card shadow-none bg-light border">
                                                        <div class="card-body">
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-12 col-lg-4">
                                                                    <label class="form-label">Customer Name</label>
                                                                    <select class="form-select form-select-sm selectclear" id="customernameid" aria-label=".form-select-sm example">
                                                                        <option selected></option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-12 col-lg-4">
                                                                    <label class="form-label">Contact Person</label>
                                                                    <input type="text" class="form-control form-select-sm text-wrap" id="contactperson" disabled>
                                                                </div>
                                                                <div class="col-12 col-lg-4">
                                                                    <label class="form-label">TelNo.</label>
                                                                    <input type="text" class="form-control form-select-sm" id="telno">
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label">Vehicle Type</label>
                                                                ...
                                                                <div class="col-12">
                                                                    <label class="form-label">Model</label>
                                                                    <select class="form-select form-select-sm selectclear" aria-label=".form-select-sm example" id="model">
                                                                    </select>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label">Serial Number</label>
                                                                    <select class="form-select form-select-sm selectclear" aria-label=".form-select-sm example" id="serialno">

                                                                    </select>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label">Engine Number</label>
                                                                    <select class="form-select form-select-sm selectclear" aria-label=".form-select-sm example" id="engineno">

                                                                    </select>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label">Complaint/Request</label>
                                                                    <textarea class="form-control form-select-sm" rows="3" cols="4" id="complaintrequest"></textarea>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label class="form-label">Component</label>
                                                                ...
                                                                <div class="col-12">
                                                                    <label class="form-label">Techician Name</label>
                                                                    <select class="form-select form-select-sm techname " id="techname" name="techname" *->
                                                                    </select>
                                                                </div>
                                                                <div class="col-12 col-lg-6">
                                                                    <label class="form-label">JCE Type</label>
                                                ...
                                                <div class="card shadow-none bg-light border">
                                                    <div class="card-body">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-12 col-lg-8">
                                                                <label class="form-label">Remarks</label>
                                                                <textarea class="form-control form-select-sm" rows="3" cols="4" id="remarks"></textarea>
                                                            </div>
                                                            <div class="col-12 col-lg-4">
                                                                <label class="form-label">Total Parts Amount</label>
                                                            ...
                                                            <div class="col-12 col-lg-4">
                                                                <label class="form-label">Freight Cost</label>
                                                                <input type="text" class="form-control form-select-sm" id="freightcost" disabled>
                                                            </div>
                                                            <div class="col-12 col-lg-8">
                                                                <label class="form-label">Validity Date</label>
                                                                <input type="text" class="form-control form-select-sm" id="validitydate" disabled>
                                                            </div>
                                                            <div class="col-12 col-lg-4">
                                                                <label class="form-label">Amount Due</label>
                                                                <input type="text" class="form-control form-select-sm" id="amtdue" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        $(document).on("click", "#viewedit", function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#vehicletypeid').val(response.viewequipment.type);
                    $('#complaintrequest').val(response.viewjce.complaint_request);
                    $('#component').val(response.viewjce.component);
                    $('#typeofissue').val(response.viewjce.typeofissue);
                    $('#promiseddate').val(response.viewjce.promised_datetime);
                    $('#resolved').val(response.viewjce.resolved);
                    $('#paymentterms').val(response.viewjce.paymentterms);
                    $('#jcetype').val(response.viewjce.jce_type);
                    $('#jcetypeparts').val(response.viewjce.jcetypeparts);
                    $('#jcechargeto').val(response.viewjce.charge_to);
                    $('#jcechargetoparts').val(response.viewjce.chargetoparts);
                    $('#dispatchdate').val(response.viewjce.dispatch_date);
                    $('#workarea').val(response.viewjce.work_area);
                    $('#laboramt').val(response.viewjce.labor_amt);
                    $('#srt').val(response.viewjce.srt_amt);
                    $('#partsamt').val(response.viewjce.parts_amt);
                    $('#jobtype').val(response.viewjce.job_type);
                    $('#dealer').val(response.viewjce.dealer);
                    $('#jobsite').val(response.viewjce.job_site);
                    $('#salestype').val(response.viewjce.salestype);
                    $('#modeofpayment').val(response.viewjce.modeofpayment);
                    $('#pono').val(response.viewjce.po_number);
                    $('#enginehours').val(response.viewjce.engine_hours);
                    $('#traveldays').val(response.viewjce.travel_days);
                    $('#totalsrtcode').val(response.viewjce.srtcode_total);
                    $('#totallaborcostamt').val(response.viewjce.laborcost_total);
                    $('#totalpartsamt').val(response.viewjce.parts_total);
                    ...
                    $.each(response.customer, function(key, item) {
                        ...
                        $("#customernameid").append(option);
                    });

                    $('#customernameid option[value=' + response.viewjce.customer_id + ']').attr('selected', 'selected');


                    $("#model").append("<option value=''>" + response.viewequipment.vehiclemodel + "</option>");
                    $("#serialno").append("<option value=''>" + response.viewequipment.serialnumber + "</option>");
                    $("#engineno").append("<option value=''>" + response.viewequipment.engineno + "</option>");
