        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Defect Code List</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 d-flex">
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ url('/FAS/add-defect-code') }}">
                                @csrf
                                <div class="col-12">
                                    <label class="form-label">Defect Code</label>
                                    <input type="text" class="form-control @error('defect_code') is-invalid @enderror" name="defect_code" value="{{ old('defect_code') }}" autofocus>
                                    @error('defect_code')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <a href="javascript:;" id="edit" data-editid="{{ $data->id }}" data-editview="{{ $data->defect_code }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
...
<script>
    $(document).ready(function() {
        ...
        $('#editsave').click(function(e) {
            e.preventDefault();
            var url = "{{ url('FAS/defect-code') }}" + "/" + $('#eid').val();
