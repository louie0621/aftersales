...
class JceController extends Controller
{
    ...
    public function printquotation(Jce $jce, $id)
    {
        //
        $viewjce = Jce::find($id);
        $viewcustomer = Customer::find($viewjce->customer_id);
        ...
        return view('fas.printquotation', ['viewtech'=> $viewtech,'viewequipment' => $viewequipment, 'viewcustomer' => $viewcustomer, 'jceparts' => $jceparts, 'jceview' => $jceview, 'jcesrtcode' => $jcesrtcode, 'jcelaborcost' => $jcelaborcost]);
    }
