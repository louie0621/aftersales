...
Route::controller(App\Http\Controllers\JceController::class)->group(function () {
    ...
    Route::get('/FAS/viewjcedetails/{id}', 'show');
    ...
    Route::post('/FAS/storejcelaborcostentry', 'storejcelaborcostentry');
    Route::post('/FAS/storejcepartsentry', 'storejcepartsentry');
...
Route::controller(App\Http\Controllers\WorkorderController::class)->group(function () {
    ...
    Route::post('/FAS/submit-work-order', 'store');
    Route::get('/FAS/viewworkorderdetails/{id}', 'show');
