        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Component List</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 d-flex">
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ url('/FAS/add-component') }}">
                                @csrf
                                <div class="col-12">
                                    <label class="form-label">Component</label>
                                    <input type="text" class="form-control @error('component') is-invalid @enderror" name="component" value="{{ old('component') }}" autofocus>
                                    @error('component')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <a href="javascript:;" id="edit" data-editid="{{ $data->id }}" data-editview="{{ $data->component }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
...
<script>
    $(document).ready(function() {
        ...
        $('#editsave').click(function(e) {
            e.preventDefault();
            var url = "{{ url('FAS/component') }}" + "/" + $('#eid').val();
            if (!$('#enm').val()) {
        ...
        $(document).on("click", "#delete", function(e) {
            var url = "{{ url('/FAS/deletecomponent') }}" + "/" + $(e.currentTarget).data("deleteid");
