        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Type of Issue List</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 d-flex">
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ url('/FAS/add-typeofissue') }}">
                                @csrf
                                <div class="col-12">
                                    <label class="form-label">Type of Issue</label>
                                    <input type="text" class="form-control @error('typeofissue') is-invalid @enderror" name="typeofissue" value="{{ old('typeofissue') }}" autofocus>
                                    @error('typeofissue')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <a href="javascript:;" id="edit" data-editid="{{ $data->id }}" data-editjt="{{ $data->typeofissue }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"> Update Type of Issue</h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#editsave').click(function(e) {
            e.preventDefault();
            var url = "{{ url('FAS/typeofissue') }}" + "/" + $('#eid').val();
            if (!$('#enm').val()) {
        ...
        $(document).on("click", "#delete", function(e) {
            var url = "{{ url('/FAS/deletetypeofissue') }}" + "/" + $(e.currentTarget).data("deleteid");
